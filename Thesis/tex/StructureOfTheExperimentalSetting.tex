...
\begin{tabular}{ | p{4cm}|p{10cm} | } 
  ...
  \hline
  \hyperref[opt:rots]{rots=int} & number of states in 360 degrees of rotation \\ 
  \hline
...
The meaning of the suboptions is explained in Section \ref{com_par_and_beh}.
