...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{agent=QLearning,agentSpecParam=[eps=0.4,epsFinal=0.0001,gam=1,initOptVal=100],level=1,env=[Viruses],shooting=True,dists=1,rots=6_0}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{agent=ExpectedSARSA,agentSpecParam=[eps=0.4,epsFinal=0.0001,gam=1,initOptVal=100],level=1,env=[Viruses],shooting=False,dists=1,rots=6_0}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{env=Tokens}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{agent=ExpectedSARSA,agentSpecParam=[eps=0.2,epsFinal=0.0001,gam=1,initOptVal=100],level=1,env=[Traps],shooting=False,dists=1,rots=22_0}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{agent=MonteCarlo,agentSpecParam=[eps=0.2,epsFinal=0.0001,gam=1,initOptVal=30],level=1,env=[Traps],shooting=False,dists=1,rots=30_0}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{agent=ExpectedSARSA,agentSpecParam=[eps=0.8,epsFinal=0.0001,gam=1,initOptVal=500],level=1,env=[Bugs,Tokens,Viruses],shooting=False,dists=1,rots=6_0}
